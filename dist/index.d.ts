...
declare function _decompress(length: number, resetValue: number, getNextValue: (a: number) => number): string | null;
 ...
 */
declare function loadBinaryFile(fileName: string): string;

/**
 * Binary safe file saving for NodeJS.
 */
declare function saveBinaryFile(fileName: string, data: string | Uint8Array): void;
